...
function Toolbar(_ref, _ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _reactIf2.default,
      { condition: ![_constants.MODE_PRESENT].includes(mode) },
      _react2.default.createElement(
        _toolbarButton2.default,
        { active: [_constants.MODE_EDIT].includes(mode), tooltip: translator.t("Edit mode"),
    ...
    _react2.default.createElement(
      _reactIf2.default,
      { condition: ![_constants.MODE_EDIT].includes(mode) },
      _react2.default.createElement(
        _toolbarButton2.default,
        { active: [_constants.MODE_PRESENT].includes(mode), tooltip: translator.t("Present mode"),
          onClick: function onClick(event) {
...
Toolbar.contextTypes = {
  ...
  presentActions: _react.PropTypes.object.isRequired,
