...
var _viewer3dPresent = require('./present3d/viewer3d-present');

var _viewer3dPresent2 = _interopRequireDefault(_viewer3dPresent);
...
var _layerConfigurator = require('./configurator/layer-configurator');
...
function Content(_ref) {
  ...
  switch (mode) {
    ...
    case constants.MODE_PRESENT:
      return _react2.default.createElement(_viewer3dPresent2.default, { state: state, width: width + 350, height: height });
    ...
    case constants.MODE_CONFIGURING_LAYER:
      return _react2.default.createElement(_layerConfigurator2.default, { width: width, height: height, state: state });
