...
export default function Content(_ref) {
  ...
  switch (mode) {
    ...
    case constants.MODE_PRESENT:
      return React.createElement(Viewer3DPresent, { state: state, width: width + 350, height: height });
    ...
    case constants.MODE_CONFIGURING_LAYER:
      return React.createElement(LayerConfigurator, { width: width, height: height, state: state });
